...
// GestorShell é reutilizado como shell genérico dos painéis educacionais
export { GestorShell as PanelShell } from "./gestor-shell";
export { GestorPageHeader as PanelPageHeader } from "./gestor-page-header";
export { ProfessorHomePanel } from "./professor-home-panel";
