...
export default async function ProfessorEmBrevePage({
  searchParams,
}: {
  ...
  return (
    <>
      <GestorPageHeader
        title={titulo}
        description="Este módulo ainda não está disponível no painel do professor."
      />
      ...
      <Card className="mx-auto max-w-lg text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          ...
          <Link
            ...
            className="inline-flex h-11 items-center justify-center rounded-lg bg-[#4097B1] px-4 text-sm font-medium text-white hover:bg-[#36899f]"
          >
            Ver minhas turmas
          </Link>
        </div>
