...
export default async function PlanosFundamentalPage() {
  ...
  return (
    <>
      <GestorPageHeader
        ...
        description={`Planos de aula produzidos para turmas do ${titulo.toLowerCase()}`}
        actions={
          <Link href="/professor/planos/novo?nivel=fundamental">
            <Button>
      ...
      <PlanosListaView
        ...
        emptyDescription={`Gere planos de aula para séries do ${titulo.toLowerCase()} com assistente IA alinhado à BNCC.`}
      />
    </>
  );
}
