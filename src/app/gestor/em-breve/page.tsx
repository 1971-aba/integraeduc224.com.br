...
export default async function GestorEmBrevePage({
  searchParams,
}: {
  ...
  return (
    <>
      <GestorPageHeader
        title={titulo}
        description="Este módulo ainda não está disponível na plataforma."
      />
      ...
      <Card className="mx-auto max-w-lg text-center">
        ...
        <CardDescription className="mt-2">
          ...
          próxima versão. Enquanto isso, utilize os módulos já disponíveis no
          menu.
        </CardDescription>
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          ...
          <Link
            href="/gestor/alunos"
            className="inline-flex h-11 items-center justify-center rounded-lg bg-blue-700 px-4 text-sm font-medium text-white transition-colors hover:bg-blue-800"
          >
            Ver alunos
          </Link>
        </div>
