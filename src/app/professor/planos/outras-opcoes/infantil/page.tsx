...
export default function OutrasOpcoesInfantilPage() {
  ...
  return (
    <>
      <GestorPageHeader
        ...
        description="Consultas e ferramentas complementares para planos da educação infantil"
      />
      <OutrasOpcoesNivelView nivel="infantil" />
    </>
  );
}
