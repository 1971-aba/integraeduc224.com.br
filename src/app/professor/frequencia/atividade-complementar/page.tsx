...
export default async function AtividadeComplementarPage() {
  ...
  return (
    <ProfessorTurmasGrid
      title={CHAMADA_TIPOS.complementar.label}
      description={CHAMADA_TIPOS.complementar.descricao}
      turmas={turmas}
      hrefForTurma={(id) => `/professor/frequencia/atividade-complementar/${id}`}
