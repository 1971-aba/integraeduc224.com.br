...
export default async function FichaNotasFundamentalPage({
  searchParams,
}: {
  ...
  if (!escolaId) {
    return (
      <>
        <GestorPageHeader
          title="Ficha de Notas — Ensino Fundamental"
  ...
  return (
    <>
      <GestorPageHeader
        title="Ficha de Notas — Ensino Fundamental"
        description="Consulta de notas das turmas do ensino fundamental vinculadas a você"
      />
