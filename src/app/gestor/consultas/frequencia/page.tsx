...
export default async function GestorConsultaFrequenciaPage({
  searchParams,
}: {
    ...
    return (
      <>
        <GestorPageHeader
          ...
          description="Consolidado de presença por turma e aluno"
          actions={<BackLink />}
        />
        <SemEscolaAlert />
      </>
  ...
  return (
    <>
      <GestorPageHeader
        title="Frequência Escolar"
        description="Percentual de presença consolidado da unidade"
        actions={<BackLink />}
      />
      ...
      <FrequenciaConsolidadaView
        ...
        filtro={filtro}
        basePath="/gestor/consultas/frequencia"
      />
    </>
  );
}
